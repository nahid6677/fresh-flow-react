...
const ProductLeftMain = () => {
    ...
    // const [products2, setProducts2] = useState(defaultHorizontalItems || []);
    ...
    // for products 1
    const handleWishlist1 = (productId) => {
        // console.log('Added to wishlist:', productId);
    };

    const handleAddToCart1 = (productId) => {
        // console.log('Added to cart:', productId);
    };

    const handleQuickView1 = (productId) => {
        // console.log('Quick view:', productId);
    };

    const handleCompare1 = (productId) => {
        // console.log('Compare:', productId);
    };
                        ...
                        <div className="product__items">
                            ...
                            <div className="product__all">
                                ...
                                <ul className="styled-pagination text-center clearfix">
                                    <li className="arrow prev active"><a href="#"><span
                                        className="fas fa-arrow-left"></span></a>
                                    </li>
                                    <li><a href="#">1</a></li>
                                    <li><a href="#">2</a></li>
                                    <li><a href="#">3</a></li>
